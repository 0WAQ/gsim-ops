...
**定位**(2026-07-20 注):分组已于 2026-07-19 定案并落地,设计正主是
`docs/design/factor-produce-groups.md`(三态:组产/单产/待产)。本文是其
机制实证储备 —— 钉死的事实(平铺位级一致/故障域/checkpoint 序号语义)
依然有效;文中"分组未拍板"为实验时点状态,已被取代。
