...
### 阶段 3 · 命令塌缩 + 契约全绿(3-5 天)—— 第一批 2026-07-09 完成

- **archive/recall 收编(阶段 2 顺延)**:`repo.archive/recall` 收编
  check.to_lib / restage 的移动+XML 重指+pnl 分流。**前置未解除**:金丝雀
  环路须先在含身份守卫的 to_lib 上(160)复跑通过 —— 本批不动,列为第二批。
