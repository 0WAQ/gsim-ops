...
checker:
  compliance:                      # 全史每日 + 容忍 + 硬顶(2026-07-16 重做)
    max_position_pct: 0.05         # 软线:Max 5% per stock
    min_total_stocks: 100
    min_long_stocks: 50
    min_short_stocks: 50
    violation_tolerance: 10        # 全史软线违规日 > 此值才拒
    hard_position_mult: 2.0        # 硬顶 = max_position_pct × 此(单日超此立拒)
  correlation:
